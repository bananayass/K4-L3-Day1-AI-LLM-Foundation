...
> Tùy thuộc vào yêu cầu cũng như doanh nghiệp nhưng bản thân Mình sẽ để dưới 0.5 để có độ chính xác cao nhất từ đó có thể giúp khách hàng có được câu trả lời thỏa đáng nhất
